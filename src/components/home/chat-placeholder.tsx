...
const ChatPlaceHolder = () => {
	return (
		<div className='sm:w-3/4 sm:block hidden bg-gray-secondary  flex-col items-center justify-center py-10'>
			<div className='flex flex-col items-center w-full justify-center py-10 gap-4'>
				...
				<Button className='rounded-full my-5 bg-green-primary hover:bg-green-primary'>
